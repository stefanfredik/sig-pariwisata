    ...
    <AdminLayout>
        <div class="max-w-2xl">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Tambah Kecamatan</h2>
                    <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">Tambahkan kecamatan baru</p>
                </div>
